...
@Test
    public void loginRegisteredUserPositivTest() throws IOException {
    String responce = getAuthorizationUser(baseURL + "/user/login",
    ...
    @Test
    public void loginRegisteredUserNegativTest() throws IOException {
        int statusCode = Request.Get(baseURL + "/user/login")
                .addHeader("Authorization", "GVzdGVyQkBiLmNvOjEyMzQ1NjdCYg==")
    ...
    public void postNewUserRegistrationTest() throws IOException {
        String response = Request.Post(baseURL + "/registration")
                .addHeader("Authorization", "b2x5YUBvbHlhLmNvbToxMjM0NTY3ODlSZm56")
                .bodyString("{\n" +
                        "  \"first_name\": \"Test\",\n" +
                        "  \"second_name\": \"Tester\"\n" +
